...
--
-- Stand-in structure for view `hubin_relasi`
--
CREATE TABLE IF NOT EXISTS `hubin_relasi` (
);
-- --------------------------------------------------------
...
--
-- Structure for view `hubin_relasi`
--
DROP TABLE IF EXISTS `hubin_relasi`;
-- in use(#1356 - View 'db_hubin.hubin_relasi' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
