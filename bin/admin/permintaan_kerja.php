...
if($_SESSION['level']=='admin'){
    if ($_SESSION['tahun_ajaran']!='') {
        ...
        $data = mysql_query( "SELECT * from hb_du_umum, hb_du_permintaan_kerja WHERE status_permintaan='Belum Terverifikasi' AND hb_du_umum.id_du=hb_du_permintaan_kerja.id_du");
        ...
        <div class='modal-dialog'>
            <div class='modal-content'>
                <div class='modal-header'>
                    ...
                    <h4 class='modal-title' id='myModalLabel'>Verifikasi Permintaan Kerja</h4> </div>
                <div class='modal-body'>
                    <form class='form-horizontal form-label-left' method='POST' action='proses_admin.php?a=verifikasi_kerja' enctype='multipart/form-data'>
                        ...
                        <div class="col-lg-8"><?php
                                    $name = "";
                                    echo "<input type='hidden' id='iddu' name='iddu' value='$d[id_du]'>";
                                    ?>
                                </div>
                </div>
            ...
            <div class='modal fade' id='tolak_kerja' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
<?php
...
?>
        <div class='modal-dialog'>
            <div class='modal-content'>
                <div class='modal-header'>
                    <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>
                    <h4 class='modal-title' id='myModalLabel'>Tolak Permintaan Kerja</h4> </div>
                <div class='modal-body'>
                    <form class='form-horizontal form-label-left' method='POST' action='proses_admin.php?a=tolak_kerja' enctype='multipart/form-data'>
                        
                        <label class='control-label col-md-3 col-sm-3 col-xs-12' for='name'>Tolak? <span class='required'></span> </label>
                        <div class="col-lg-8"><?php
                                    $name = "";
                                    echo "<input type='hidden' id='iddu' name='iddu' value='$d[id_du]'>";
                                    ?>
